...
class GalleryList
{
    ...
    *
    * @widget('GalleryList', ['a' => 'someVal', 'b' => 'foo'])
    */
	public function data()
	{
        $blog = DB::table('gallery')->whereNull('deleted_at');
        $contents = $blog->take(3)->get();
        $pages = $blog->paginate(3);

        $data = array('contents'=>$contents, 'pages'=>$pages);
        return $data;
	}
    ...
    */
    ...
    public $template='widget.gallery';
}
