    ...
    <div class="col-md-8">
        <div class="box box-success box-solid">
            ...
            <div class="box-footer text-center">
                ...
                <input type="hidden"  name="nama_peserta" value= "<?php echo e($peserta->nama); ?>" />
                <button type="submit" class="btn btn-default btn-md">Submit<i class="fa fa-disk"></i></button>
                </form>
            </div>
            <?php endif; ?>
            <?php if($peserta->submit_status == 2 && (CRUDBooster::myPrivilegeId() == 1 || CRUDBooster::myPrivilegeId() == 4)): ?>
            <div class="box-footer text-center">
            <form class='form-horizontal' method='post' id="form" enctype="multipart/form-data" action="<?php echo e(Route('sertifikasi.approve')); ?>">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                <input type="hidden"  name="sertifikasi_id" value= "<?php echo e($peserta->id); ?>" />
                <input type="hidden"  name="peserta_id" value= "<?php echo e($peserta->user_id); ?>" />
            ...
            <?php if($peserta->submit_status == 5 && empty($peserta->jadwal_id) && (CRUDBooster::myPrivilegeId() == 1 || CRUDBooster::myPrivilegeId() == 4)): ?>
            <div class="row">
            <div class="box-body">
            <div class="col-md-12">
            <div class="box box-success box-solid">
            ...
            <div class="box-body">
               <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <ul class="timeline">
                    <li class="time-label">
                        <span class="bg-red">
                        <?php echo e(date('d M Y', strtotime($log->created_at))); ?>
                    ...
                    <li>
                        ...
                        <div class="timeline-item">
                            <span class="time"><i class="fa fa-clock-o"></i> <?php echo e(date('G:s', strtotime($log->created_at))); ?></span>
                            <h3 class="timeline-header"><?php echo e($log->message); ?></h3>
                        </div>
                    </li>
                </ul>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
