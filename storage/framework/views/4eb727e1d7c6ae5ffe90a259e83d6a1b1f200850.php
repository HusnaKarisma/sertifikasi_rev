    ...
    <section class="sidebar">
        ...
        <div class='main-menu'>
            ...
            <ul class="sidebar-menu">
                ...
                <?php if($dashboard): ?>
                    <li data-id='<?php echo e($dashboard->id); ?>' class="<?php echo e((Request::is(config('crudbooster.ADMIN_PATH'))) ? 'active' : ''); ?>"><a href='<?php echo $dashboard->url; ?>' class='<?php echo e(($dashboard->color)?"text-".$dashboard->color:""); ?>' ><i class='fa fa-dashboard'></i> <span><?php echo e(trans("crudbooster.text_dashboard")); ?></span> </a></li>
                <?php endif; ?>
