...
<div class="row">
    ...
    <form class="form-horizontal" id="form-register" method="post" action="<?php echo e(Route('sertifikasi.register')); ?>">
    ...
    <div class="form-group" id="nama" name="nama">
        ...
        <div class="form-group" id="propinsi">
          ...
          <div class="col-sm-8">
            ...
            <?php $__currentLoopData = $propinsi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-group" id="alamat" name="alamat">
          ...
          <div class="form-group" id="pendidikan">
              ...
              <div class="col-sm-8">
                ...
                <?php $__currentLoopData = $pendidikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($k->Pendidikan); ?>"><?php echo e($k->Pendidikan); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
          </div>
              ...
              <div class="form-group" id="alamatInsntansi" name="alamatInstansi">
                ...
                <div class="form-group">
                        ...
                        <select name="tujuan_id" id="tujuan_id" class="form-control">
                          <?php $__currentLoopData = $tujuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group" id="kluster">
                        ...
                        <div class="col-sm-8">
                          ...
                          <?php $__currentLoopData = $klusters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($k->id); ?>"><?php echo e($k->kluster_code); ?> - <?php echo e($k->kluster_name); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
                        </div>
                </div>
...
$(function() {
  ...
  $('#inputNip').blur(function(){
    ...
    $.ajax({
        url: "<?php echo e(url('api/pustakawan')); ?>/"+nip,
        type: "GET",
  ...
  $('#propinsi_id').change(function(){
    var prop = $(this).val();
    $.ajax({
        url: "<?php echo e(url('api/kabupatens')); ?>/"+prop,
        type: "GET",
        success: function(data) {
          var len = data.length;
  ...
  $('#kabupaten_id').change(function(){
    var kab = $(this).val();
    $.ajax({
        url: "<?php echo e(url('api/kecamatans')); ?>/"+kab,
        type: "GET",
        success: function(data) {
          var len = data.length;
  ...
  $('#kecamatan_id').change(function(){
    var kec = $(this).val();
    $.ajax({
        url: "<?php echo e(url('api/kelurahans')); ?>/"+kec,
        type: "GET",
        success: function(data) {
          var len = data.length;
