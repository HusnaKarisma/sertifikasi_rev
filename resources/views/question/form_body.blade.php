...
foreach($forms as $index=>$form) {
  ...
  $detailform[$form['name']] = $form;
}

// dd($detailform);

$form = $detailform['question_group_id'];
?>
@include('crudbooster::default.type_components.select2.component')


<?php
$form = $detailform['question'];
?>
@include('crudbooster::default.type_components.wysiwyg.component')
