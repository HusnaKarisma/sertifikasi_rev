  ...
  <div class="row">
    <div class="col-md-9">
      <div class="box box-success box-solid">
        ...
        @endif
        @if($peserta->submit_status == 2 && CRUDBooster::myPrivilegeId() == 1)
        <div class="box-footer text-center">
        ...
        @endif
        @if($peserta->submit_status == 5 && CRUDBooster::myPrivilegeId() == 1 && empty($peserta->jadwal_id))
        <div class="col-md-12">
        <div class="box box-success box-solid">
          <div class="box-header with-border">
    ...
    <div class="col-md-3">
      <div class="box box-success box-solid">
        <div class="box-header with-border">
          <h3 class="box-title">COCOK COCOK JUANCUK</h3>
        </div>
